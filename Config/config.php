<?php
// Do not edit this file directly while inside the container! It is automatically generated after every container start.
// To clarify, this file is used as a template by misp_create_configs.py to generate a corresponding config.php in the container.
...
{% if S3_ENABLED %}
$plugin['S3_enable'] = true;
$plugin['S3_aws_compatible'] = {{ S3_AWS_COMPATIBLE | bool }};
{% if S3_CA %}
$plugin['S3_aws_ca'] = {{ S3_CA | str }};
{% endif %}
$plugin['S3_aws_ca_validate'] = {{ S3_CA_VALIDATE | bool }};
$plugin['S3_aws_endpoint'] = {{ S3_AWS_ENDPOINT | str }}; 
$plugin['S3_bucket_name'] = {{ S3_BUCKET_NAME | str }}; 
{% if S3_REGION %}
$plugin['S3_region'] = {{ S3_REGION | str}};
{% endif %}
$plugin['S3_aws_access_key'] = {{ S3_ACCESS_KEY | str }};
$plugin['S3_aws_secret_key'] = {{ S3_SECRET_KEY | str }};
{% endif %}
...
$config = [
  ...
  'MISP' => [
    ...
    'log_client_ip' => true,
    'language' => 'eng',
    'attachments_dir' => '{{ "s3://" if S3_ENABLED else "/var/www/MISP/app/attachments" }}',
    'live' => true,
